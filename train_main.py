...
training_directory="/Users/NunoAlberto/Desktop/Computer Science/3rd Year/tb2/Individual Project/seq2point-nilm/reddMicrowave/microwave_training_.csv"
validation_directory="/Users/NunoAlberto/Desktop/Computer Science/3rd Year/tb2/Individual Project/seq2point-nilm/reddMicrowave/microwave_validation_.csv"
...
parser.add_argument("--crop", type=int, default="1571848", help="The number of rows of the dataset to take training data from. Default is 10000. ")
...
parser.add_argument("--epochs", type=int, default="100", help="Number of epochs. Default is 10. ")
